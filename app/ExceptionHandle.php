...
/*    public function render(Request $request, Throwable $e): Response
    ...
    {
        /**
         * @var $e \think\exception\HttpException
         */
        $this->isJson = true;
...
//            var_dump( str_contains($this->app->request->header('content-type'),'json'));
            // 循环引用检测并直接置空 traces（比起循环引用导致的报错，置空后开发者能得到更多真实的错误信息）
            if ($this->app->request->isJson() or str_contains($this->app->request->header('content-type'),'json')) {
