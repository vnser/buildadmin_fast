...
$server = isset($_REQUEST['server']) || isset($_SERVER['HTTP_SERVER']) || substr($_SERVER['REQUEST_URI'], 1, 9) == 'index.php' || $_SERVER['REQUEST_METHOD'] == 'OPTIONS' || str_contains($_SERVER['HTTP_CONTENT_TYPE']??'','json');
if (!$server) {
    /*
     * 用户访问前端
